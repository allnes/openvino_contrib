...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(std::make_pair("ov_arm_gpu_plugin", CommonTestUtils::DEVICE_GPU)));
...
using IEClassGetConfigTestARM_GPU = BehaviorTestsUtils::IEClassNetworkTest;

TEST_F(IEClassGetConfigTestARM_GPU, smoke_GetConfigNoThrow) {
    InferenceEngine::Core ie = BehaviorTestsUtils::createIECoreWithTemplate();
    InferenceEngine::Parameter p;
    std::string deviceName = CommonTestUtils::DEVICE_GPU;
