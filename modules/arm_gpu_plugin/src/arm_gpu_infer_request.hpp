...
class ArmGpuInferRequest : public InferenceEngine::IInferRequestInternal {
public:
    typedef std::shared_ptr<ArmGpuInferRequest> Ptr;

    ArmGpuInferRequest(const InferenceEngine::InputsDataMap& networkInputs,
                         const InferenceEngine::OutputsDataMap& networkOutputs,
                         const std::shared_ptr<ExecutableNetwork>& executableNetwork);
    ArmGpuInferRequest(const std::vector<std::shared_ptr<const ov::Node>>& inputs,
